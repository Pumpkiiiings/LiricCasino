...
class DatabaseManager(private val plugin: CasinoPlugin) {
            ...
            conn.createStatement().use { stmt ->
                stmt.execute("""
                    CREATE TABLE IF NOT EXISTS casino_stats (
                        ...
                        coinflip_daily_uses INT        DEFAULT 0,
                        racing_wagered    DOUBLE       DEFAULT 0,
                        racing_won        DOUBLE       DEFAULT 0,
                        racing_wins       INT          DEFAULT 0,
                        racing_losses     INT          DEFAULT 0,
                        racing_daily_uses INT          DEFAULT 0,
                        rps_daily_uses    INT          DEFAULT 0,
                        ttt_daily_uses    INT          DEFAULT 0,
                        poker_daily_uses  INT          DEFAULT 0,
    ...
    private fun migrateColumns() {
        val newColumns = mapOf(
            ...
            "roulette_daily_uses" to "INT DEFAULT 0",
            "slots_daily_uses"    to "INT DEFAULT 0",
            "bj_daily_uses"       to "INT DEFAULT 0",
            "scratch_daily_uses"  to "INT DEFAULT 0",
            "lottery_daily_uses"  to "INT DEFAULT 0",
            "coinflip_daily_uses" to "INT DEFAULT 0",
            "racing_daily_uses"   to "INT DEFAULT 0",
            "rps_daily_uses"      to "INT DEFAULT 0",
            "ttt_daily_uses"      to "INT DEFAULT 0",
            "poker_daily_uses"    to "INT DEFAULT 0",
            "last_daily_reset"    to "BIGINT DEFAULT 0"
        )
